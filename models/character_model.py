...
class CharacterModel(Base):
    ...
    def __repr__(self) -> str:
        ...
        return f"<Character: (id={self.id},character_id={self.CharacterID}, gender={self.Gender}s,str={self.Str},dex={self.Dex},int={self.Int},fai={self.Fai},arc={self.Arc},weight={self.Weight})>"